...
/** \brief trae un elemento de la lista
 *
 * \param this LinkedList* Puntero a la lista
...
/**
 * @brief itera los elementos de la lista y se los pasa al putnero a funcion
 *
 * @param this puntero a la lista
 * @param pFunc una funcion con su funcionalidad
 * @return nueva lista
 */
...
/**
 * @brief itera los elementos de la lista y los filtra segun el criterio de pFunc
 *
 * @param this puntero a la lista
 * @param pFunc una funcion con su funcionalidad
 * @return nueva lista
